...
class Solver(_object):
    ...
    def LoadModel(self, *args): return _pywraplp.Solver_LoadModel(self, *args)
    def ExportModel(self, *args): return _pywraplp.Solver_ExportModel(self, *args)
    def FillSolutionResponse(self, *args): return _pywraplp.Solver_FillSolutionResponse(self, *args)
    __swig_getmethods__["SolveWithProtocolBuffers"] = lambda x: _pywraplp.Solver_SolveWithProtocolBuffers
    if _newclass:SolveWithProtocolBuffers = staticmethod(_pywraplp.Solver_SolveWithProtocolBuffers)
    ...
    def set_write_model_filename(self, *args): return _pywraplp.Solver_set_write_model_filename(self, *args)
    def write_model_filename(self): return _pywraplp.Solver_write_model_filename(self)
    ...
    def CheckNameValidity(self, *args): return _pywraplp.Solver_CheckNameValidity(self, *args)
    def CheckAllNamesValidity(self): return _pywraplp.Solver_CheckAllNamesValidity(self)
    ...
    def ObjectiveValue(self): return _pywraplp.Solver_ObjectiveValue(self)
    def BestObjectiveBound(self): return _pywraplp.Solver_BestObjectiveBound(self)
    def ClearObjective(self): return _pywraplp.Solver_ClearObjective(self)
    def SetObjectiveCoefficient(self, *args): return _pywraplp.Solver_SetObjectiveCoefficient(self, *args)
    def SetObjectiveOffset(self, *args): return _pywraplp.Solver_SetObjectiveOffset(self, *args)
    def AddObjectiveOffset(self, *args): return _pywraplp.Solver_AddObjectiveOffset(self, *args)
    def SetOptimizationDirection(self, *args): return _pywraplp.Solver_SetOptimizationDirection(self, *args)
    def SetMinimization(self): return _pywraplp.Solver_SetMinimization(self)
    def SetMaximization(self): return _pywraplp.Solver_SetMaximization(self)
    def Maximization(self): return _pywraplp.Solver_Maximization(self)
    def Minimization(self): return _pywraplp.Solver_Minimization(self)
...
def Solver_SolveWithProtocolBuffers(*args):
  return _pywraplp.Solver_SolveWithProtocolBuffers(*args)
Solver_SolveWithProtocolBuffers = _pywraplp.Solver_SolveWithProtocolBuffers
...
class MPSolverInterface(_object):
    ...
    def ObjectiveValue(self): return _pywraplp.MPSolverInterface_ObjectiveValue(self)
    ...
    def WriteModel(self, *args): return _pywraplp.MPSolverInterface_WriteModel(self, *args)
